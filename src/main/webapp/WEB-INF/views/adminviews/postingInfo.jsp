	...
	<main style="background-color: #f5f5f5">
		<div class="container-fluid px-4">
			...
			<ol class="breadcrumb bottomline header-custom">
				...
				<li>
					<div class="option-plus-btn" style="display:none;">
			...
			<form method="post" action="putProduct.seller">
						...
						<div class="col-10 search-input">
							<div class="radio-productCode">
								<div class="btn-group" role="group"
									...
									<select class="form-select selectState" id="category" name="cate_code" disabled
				...
				<div class="text-end mb-5">
					<button type="button" class="btn btn-outline-secondary btn-size" onclick="location.href='/house/productManagementList.admin'">확인</button>
					<button class="btn btn-outline-secondary btn-size" type="reset" style="display:none;">취소</button>
					<button class="btn btn-secondary btn-size" onclick="gatherData()"  style="display:none;">등록하기</button>
				</div>
