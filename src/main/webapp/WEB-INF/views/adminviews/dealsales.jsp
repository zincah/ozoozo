...
<c:forEach items="${dealList }" var="deal">
	<tr class="content-table-content content-hover">
	  <td class="content-table-content-text option-line">
	    <input class="check form-check-input form-check-input-margin" type="checkbox" value="" name="dealcheckbox" onchange="checkfunction()"/>
	  </td>
	  ...
	  <td class="content-table-content-text option-line">${deal.payment }</td>
