...
<tr class="content-table-content">
    ...
    <td colspan="2" class="content-table-content-text"><fmt:formatDate value="${couponViewData.coupon_enddate}"
    pattern="yyyy-MM-dd"/>
...
<tr class="content-table-content">
    ...
    <td colspan="5" class="content-table-content-text">
        <div id="coupon_title_select">${couponViewData.coupon_title}</div>
...
<tr class="content-table-content">
    ...
    <td colspan="5" class="content-table-content-text">
        <textarea class="form-control table-input" id="coupon_content" disabled="">${couponViewData.coupon_subtitle}</textarea>
    </td>
</tr>
