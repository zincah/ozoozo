				...
				<table class="table table-box-style content-view-table">
					<tbody>
						<tr class="content-table-content">
							...
							<td class="content-table-content-text option-line"
								id="info_charge" style="width: 20%;">이인하</td>
						</tr>
						<tr class="content-table-content">
							<td
								class="content-table-content-text option-line content-table-title"
						...
						<tr class="content-table-content">
							...
							<td colspan="1" class="content-table-content-text">
								<button type="button" class="btn btn-secondary btn-size">업로드</button>
								<button type="button" class="btn btn-outline-secondary btn-size">취소</button>
							</td>
						</tr>
