	...
	<div class="col-12 col-md-4 col-lg-3">
		<div class="deals_list_wrap">
			<article class="deals_item">
				<a id="${product.post_id }"
					href="productPage.com?p=${product.post_id }"
					...
					<div class="deals_item_wrap">
						...
						<div class="deals_item_content">
							...
							<div class="best_item_info">
								<c:if test="${product.shipping_info1 == 'free'}">
									<svg id="freeship_icon" class="icon" aria-label="무료배송"
										...
										preserveAspectRatio="xMidYMid meet">
		                                       <g fill="none"
											fill-rule="evenodd">
		                                       <rect width="47" height="20"
											fill="#000" fill-opacity=".07" fill-rule="nonzero" rx="4"></rect>
		                                       <path fill="#757575"
								...
								<svg id="saleprice_icon" class="icon" aria-label="특가" width="30"
