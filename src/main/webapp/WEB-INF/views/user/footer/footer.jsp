      ...
      <div class="layout-footer__content">
        <div class="layout-footer__top">
          <address class="layout-footer__cs">
            ...
            <div class="layout-footer__cs__row">
              <a class="layout-footer__cs__tel" href="tel:0000-0000"
                >0000-0000</a
              >
            </div>
            <span class="layout-footer__cs__time"
              >평일 09:00 ~ 18:00 (주말 &amp; 공휴일 제외)</span
            >
          </address>
          <div class="layout-footer__outbound">
            ...
            ><a
              class="layout-footer__outbound__item"
              href="https://story.kakao.com/ch/bucketplace"
              target="_blank"
              rel="noreferrer noopener"
              title="카카오스토리"
              aria-label="카카오스토리"
            ...
            ><a
              class="layout-footer__outbound__item"
              href="https://blog.naver.com/bucket_place"
              target="_blank"
              rel="noreferrer noopener"
              title="네이버 블로그"
              aria-label="네이버 블로그"
        ...
        <ul class="layout-footer__shortcut">
          <li>
            <a
              class="layout-footer__shortcut__item_first"
              rel="noopener"
          ...
          <li>
            <a
              class="layout-footer__shortcut__item"
              rel="noopener"
              href="/contacts/new?type=request"
              target="_blank"
              >제휴/광고 문의</a
            >
          </li>
        ...
        <address class="layout-footer__info-wrap">
          <dl class="layout-footer__info">
            <a
              class="layout-footer__info__item"
              href="http://bucketplace.co.kr/"
              target="_blank"
            >
              상호명 : (주)오조플레이스
            ...
            <span class="layout-footer__info__item">
              이메일 : (고객문의)
              <a href="mailto:cs@ozoplace.com"> cs@ozoplace.com </a>
              (제휴문의)<a href="mailto:contact@ozoplace.com">
                contact@ozoplace.com
              </a>
            </span>
            <span class="layout-footer__info__item"> 대표이사 : 김오조 </span>
            <span class="layout-footer__info__item">
              사업자등록번호 : 110-80-90205
            </span>
            <span class="layout-footer__info__item">
              통신판매업신고번호 : 제2022-서울종로-0500호
              <b class="layout-footer__info__item__check-link"
                >&nbsp;사업자정보확인</b
              >
            </span>
          </dl>
          <dl class="layout-footer__info">
            <span class="layout-footer__info__item">
              주소 : 서울 종로구 돈화문로 20 단성사, 4층
            </span>
            <span class="layout-footer__info__item">
              오조은행 채무지급보증안내 : (주)오조플레이스는 고객님이
              현금결제한&nbsp; 금액에 대해 오조은행과 채무지급보증 계약을
          ...
          <span class="layout-footer__info">
            <span class="layout-footer__info__item"
              >오조의집은 개별 판매자가 상품을 판매하는 오픈마켓이며
              (주)오조플레이스는 통신판매중개자로 거래 당사자가 아니므로,
              판매자가 등록한 상품정보 및 거래 등에 대해 일체 책임을 지지
              않습니다. <br />단 ㈜오조플레이스가 판매자로 등록 판매한 상품의
              경우는 판매자로서 책임을 부담합니다.</span
            >
          </span>
        </address>
        <p class="layout-footer__copyright">
          Copyright 2022. ozoplace, Co., Ltd. All rights reserved
        </p>
      </div>
    </footer>
    <script>
